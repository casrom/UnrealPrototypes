...
AMyProjectCharacter::AMyProjectCharacter()
{
	...
	// Base Builder
	Builder = CreateDefaultSubobject<UBuilderComponent>(TEXT("BaseBuilder"));
	Builder->SetCamera(FirstPersonCameraComponent);
...
void AMyProjectCharacter::Tick(float DeltaTime) { 
	...
	//if (GetCapsuleComponent()->ComponentVelocity.SizeSquared() < 1) DisableSimulatePhysics();
}
...
void AMyProjectCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// Bind scroll event
	PlayerInputComponent->BindAxis("Scroll", this, &AMyProjectCharacter::OnScroll);
	PlayerInputComponent->BindAction("Interact", IE_Pressed, this, &AMyProjectCharacter::OnInteract);
	PlayerInputComponent->BindAction("Build", IE_Pressed, this, &AMyProjectCharacter::OnToggleBuilder);
...
void AMyProjectCharacter::OnToggleBuilder() {
	Builder->ToggleBuilder();
}

void AMyProjectCharacter::EnableSimulatePhysics() {
	GetCapsuleComponent()->SetSimulatePhysics(true);
}

void AMyProjectCharacter::DisableSimulatePhysics() {
